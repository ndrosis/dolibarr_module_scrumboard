 ...
 */
class scrumboardbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "scrumboard@scrumboard";
    public $boxlabel;
    public $depends = array("scrumboard");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/scrumboard/class/scrumboard.class.php";
